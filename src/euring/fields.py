...
EURING_FIELDS = (
    ...
    EuringField(name="Wing Length", key="wing_length", euring_type=TYPE_NUMERIC, required=False),
    EuringField(name="Third Primary", key="third_primary", euring_type=TYPE_NUMERIC, required=False),
    EuringLookupField(
    ...
    EuringField(name="Mass", key="mass", euring_type=TYPE_NUMERIC, required=False),
    EuringLookupField(
        name="Moult",
        key="moult",
        euring_type=TYPE_ALPHABETIC,
    ...
    EuringField(name="Hind Claw", key="hind_claw", euring_type=TYPE_NUMERIC, required=False),
    EuringField(name="Bill Length", key="bill_length", euring_type=TYPE_NUMERIC, required=False),
    EuringLookupField(
        name="Bill Method",
        key="bill_method",
        euring_type=TYPE_ALPHABETIC,
    ...
    EuringField(name="Total Head Length", key="total_head_length", euring_type=TYPE_NUMERIC, required=False),
    EuringField(name="Tarsus", key="tarsus", euring_type=TYPE_NUMERIC, required=False),
    EuringLookupField(
        name="Tarsus Method",
        key="tarsus_method",
        euring_type=TYPE_ALPHABETIC,
    ...
    EuringField(name="Tail Length", key="tail_length", euring_type=TYPE_NUMERIC, required=False),
    EuringField(name="Tail Difference", key="tail_difference", euring_type=TYPE_NUMERIC, required=False),
    EuringField(name="Fat Score", key="fat_score", euring_type=TYPE_INTEGER, length=1, required=False),
    EuringLookupField(
    ...
    EuringField(name="Primary Moult", key="primary_moult", euring_type=TYPE_ALPHANUMERIC, length=10, required=False),
    EuringFormattedField(
    ...
    EuringField(name="Alula", key="alula", euring_type=TYPE_INTEGER, length=1, required=False),
    EuringLookupField(
        name="Carpal Covert",
        key="carpal_covert",
        euring_type=TYPE_INTEGER,
    ...
    EuringField(name="Place Name", key="place_name", euring_type=TYPE_TEXT, required=False),
    EuringField(name="Remarks", key="remarks", euring_type=TYPE_TEXT, required=False),
    EuringField(name="Reference", key="reference", euring_type=TYPE_TEXT, required=False),
    EuringFormattedField(
        name="Latitude", key="latitude", euring_type=TYPE_NUMERIC_SIGNED, required=False, parser=parse_latitude
    ),
    EuringFormattedField(
        name="Longitude",
        key="longitude",
        euring_type=TYPE_NUMERIC_SIGNED,
        required=False,
